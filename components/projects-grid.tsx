    ...
    <main className="bg-[#0A0A0A]">
      ...
      <section className="pt-40 pb-20 lg:pt-48 lg:pb-28 border-b border-white/5">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          >
            <p className="text-xs font-medium tracking-[0.15em] text-white/50 uppercase mb-6 font-dm">
              Portfolio
            </p>
      ...
      >
        ...
        >
          ...
          <div className="absolute top-6 right-6">
            <span className="text-xs font-dm text-white/30 bg-black/30 px-3 py-1 rounded-full backdrop-blur-sm">
              {project.year}
            </span>
          </div>
        ...
        <div>
          ...
          <p className="text-xs text-white/50 uppercase tracking-[0.1em] font-dm mb-3">
            {project.category}
          </p>
